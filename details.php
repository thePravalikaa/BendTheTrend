...
<head>
	...
	<script type="text/javascript">
		function validate(){
			if(formValidate.product_qty.selectedIndex == 0){
				alert("Please select the product quantity");
				formValidate.product_qty.focus();
				return false;
			}
			if(formValidate.product_size.selectedIndex == 0){
				alert("Please select the product size");
				formValidate.product_size.focus();
				return false;
			}
			return true;
		}
				...
				<div class="row" id="productMain"><!-- row Starts -->
					...
					<div class="col-sm-6" ><!-- col-sm-6 Starts -->
						...
						<div class="box" ><!-- box Starts -->
							...
							<form action="details.php?add_cart=<?php echo $product_id; ?>" method="post" class="form-horizontal" name="formValidate"><!-- form-horizontal Starts -->
